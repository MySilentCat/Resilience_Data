        ...
        <el-col :span="24"
          ><el-card class="box-card" style="height: 100%">
            <div slot="header" class="clearfix">
              <span class="fileLevelTitle">基于静态贝叶斯网络的软件架构韧性评估</span>
      ...
      <el-row style="height: 80%; width: 100%">
        ...
        <el-col :span="6" style="height: 100%">
          <el-card class="box-card" style="width: 99%; height: 50%" shadow="hover">
            ...
            <div ref="attack_nodes" class="text item">攻击节点个数：</div>
            <div ref="comp_edges" class="text item">组件节点个数：</div>
          ...
          <el-card class="box-card" style="width: 99%; height: 50%" shadow="hover">
            ...
            <div ref="p" class="text item">边缘概率：</div>
          </el-card>
        </el-col>
      </el-row>
    </div>
    ...
    mounted() {
      ...
      window.addEventListener("message", (e) => {
        ...
        if (e.data.flag == "graph") {
          if (this.$refs.attack_nodes) {
            this.$refs.attack_nodes.innerHTML = "攻击节点个数：" + e.data.data["Attack_nums"];
            this.$refs.comp_edges.innerHTML = "组件节点个数：" + e.data.data["Comp_nums"];
            this.$refs.re.innerHTML =
              "韧性评估结果：" + e.data.data["Resilience"];
          }
        }
        if (e.data.flag == "node") {
          if (this.$refs.node_name) {
            ...
            this.$refs.p.innerHTML = "边缘概率：" + e.data.data["marginal_prob"];
          }
        }
      });
      ...
      // console.log("%%%%%%", params);
      if (params.title == "UML_StaticView") {
        this.url = "/Static_UML.html";
      } else {
