    ...
    <div style="height: 88vh;">
          ...
          <el-col :span="24"><el-card class="box-card" style="height:100%">
                    <div slot="header" class="clearfix">
                      ...
                      <el-popover placement="right" trigger="click" style="margin-left: 5px">
                        <div>&bull; 节点表示函数，实线表示控制依赖关系，虚线表示数据依赖关系</div>
                    ...
                    <p id="intro_text">系统依赖图（System Dependence Graph, SDG）是对过程依赖图（PDG）的扩展， SDG是一个有向图G=(N,E)，其中，N中的每个节点表示程序代码中的函数，而E中的每条边表示的是节点中的依赖关系。在SDG中，边分为两种类型：控制依赖边和数据依赖边。
                SDG 可以用于表示和分析系统中各组件之间依赖关系，包括数据依赖、控制依赖等，可以帮助开发人员更好地理解系统结构和优化系统性能，提高系统的可靠性、可维护性和可扩展性。</p>
                  </el-card></el-col>
        </el-row>
        ...
        <el-row style="height:80%;width:100%">
          ...
          <div style="width:98%;height: 100%;">
            ...
            <iframe :src="g_url+url" style="width:100%;height: 100%;border:none"></iframe>
        </div>
            </el-col>
    ...
    mounted() {
        ...
        window.addEventListener('message', (e)=>{
            ...
            if(e.data.flag == "graph"){
                if(this.$refs.number_of_nodes){this.$refs.number_of_nodes.innerHTML = "节点个数：" + e.data.data["节点个数："]
            ...
            if(e.data.flag == "node"){
                if(this.$refs.node_name){this.$refs.node_name.innerHTML = "节点名称：" + e.data.data["节点名称："]
        ...
        if (params.title == "SDG") {
            ...
            this.url = "/graphs/radar/radar.html"
        }
    }
}
