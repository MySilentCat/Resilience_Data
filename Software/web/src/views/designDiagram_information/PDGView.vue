        ...
        ><el-card class="box-card" style="height: 100%">
          <div slot="header" class="clearfix">
            ...
            <el-popover placement="right" trigger="click" style="margin-left: 5px">
              <div>&bull; 节点表示语句，实线表示控制依赖关系，虚线表示数据依赖关系</div>
...
export default {
  ...
  mounted() {
    ...
    utilsApi.axiosMethod({
      method: "get",
      url: config.BASE_URL + "/PDG/" + _this.$store.state.current_project.name,
      callback: (res) => {
        //  console.log(res)
    ...
    // let treeData = require(`./${projectName}/graphs/pdg.js`).treeData
    // // let treeData = require(`../../../public/project/${projectName}/graphs/pdg.js`).treeData
    // console.log("$$$", projectName, treeData)
    // this.fileTreeData = treeData
    // import(`../../../public/project/${projectName}/graphs/pdg.js`).then((treeData) => {
    //     // console.log("$$$", projectName, treeData)
