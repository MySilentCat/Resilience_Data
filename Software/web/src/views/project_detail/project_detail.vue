...
<template>
    <div v-loading="loading">
        <div class="main" v-if="projectFlag == 1">
            <div class="main-left">
            ...
            <div class="main-right">
                ...
                <div class="table3">
                    <el-table height="33vh" :data="tableData3" border
                        ...
                        <el-table-column prop="status" label="状态1" align="center">
                            <template slot-scope="scope">
        ...
        <div class="main" v-else>
            <div class="table4">
                <el-table height="89vh" :data="tableData3" border
                    :header-cell-style="() => { return 'background: rgb(182, 254, 230);color:black;' }">
                    <el-table-column prop="name" label="源码文件" align="center">
                    </el-table-column>
                    <el-table-column prop="path" label="路径" align="center">
...
export default {
    ...
    methods: {
        ...
        getProjectInfo() {
            ...
            utils.axiosMethod({
                method: "GET",
                url: config.BASE_URL + "/mainWindow/" + _this.project.name,
                callback: (res) => {
                    _this.loading = false
                    ...
                    if (res.data.projectFlag == 0) {
                        _this.projectFlag = 0
                        _this.$message.error(res.data.msg)
                        // 禁用菜单栏
                        _this.$store.commit("setMenuDisabled", true)
                        return
                    }
