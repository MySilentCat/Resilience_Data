...
def code_comment_line(code_text: list):
    ...
    return total_code_line, vaild_code_line, total_comment_line, vaild_comment_line, [com[0] for com in comment_text]
...
def projectInclude(codeFileList, projectPath):  # 传入源文件列表和项目文件夹路径
    ...
    with open(projectPath + "/fan_dict.json", "r", encoding="utf-8") as f:
